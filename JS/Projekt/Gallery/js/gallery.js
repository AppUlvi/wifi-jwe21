...
let divClassLightbox = $(
    `<div id="lightbox" class="hide"> <img class="close" src="img/close.png" alt="close-button"> <div class="lightboxInner"></div> </div>`
);
